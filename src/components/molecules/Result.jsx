...
const generateTweetMessage = (fees, transactions) =>
  `I spent only $${fees} in fees for all of my ${transactions} Solana transactions, at the current SOL price!%0A%0A%23OPOS%0A%0ACheck yours at https://www.solfees.fyi by %40ronnyhaase`
